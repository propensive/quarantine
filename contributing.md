...
Firstly, thank you for taking an interesting in contributing! Quarantine is an open-source project, and welcomes
...
Quarantine is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Quarantine is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.quarantine:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.quarantine:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/quarantine` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Quarantine does not use automatic code-formatting
...
development environment for all Quarantine&rsquo;s users. Propensive O&Uuml; reserves the right to censure
